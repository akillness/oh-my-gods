...
## 문제 정의
- 이슈: `omg` PLAN 단계에서 `plannotator`가 시작되지 않아 승인 게이트가 막힘.
- 관측 에러:
...
### 코드
- 수정: `.agent-skills/omg/scripts/plannotator-plan-loop.sh`
