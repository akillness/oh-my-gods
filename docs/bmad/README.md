...
[![GitHub Releases](https://img.shields.io/badge/GitHub-Releases-blue)](https://github.com/akillness/oh-my-gods/releases)
[![Release Notes](https://img.shields.io/badge/release-notes-blue)](https://github.com/akillness/oh-my-gods/releases)
...
`bmad`는 기본적으로 Claude Code에서 안정적으로 동작하는 설계입니다.  
